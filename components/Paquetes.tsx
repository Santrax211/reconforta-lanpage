    ...
    <section id="paquetes" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#f1a999] rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 text-[#0C1D33] text-center">Plan Básico</h3>
            <ul className="list-disc list-inside mb-4 text-black-600">
          ...
          <div className="bg-[#F7F7F7] rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 text-[#0C1D33] text-center">Plan Regular</h3>
          ...
          <div className="bg-[#F7F7F7] rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold mb-4 text-[#0C1D33] text-center">Plan Premium</h3>
            <ul className="list-disc list-inside mb-4 text-gray-600">
