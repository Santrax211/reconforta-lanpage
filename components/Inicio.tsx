  ...
  return (
    <section id="inicio" className="relative min-h-screen">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 text-center text-white">
        ...
        {/* WhatsApp Button */}
        <a
          href="https://wa.me/51943018733"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-16 right-8 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full p-4 shadow-lg transition-all duration-300"
        >
          <svg
            className="w-8 h-8"
            fill="currentColor"
